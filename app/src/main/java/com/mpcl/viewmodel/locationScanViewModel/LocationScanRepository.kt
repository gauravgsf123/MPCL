...
class LocationScanRepository {
    ...
    suspend fun scanLocation(cid:String,bid:String,empno:String,boxnumber:String,branchName:String):List<ScanLocationResponseModel>? = RetrofitInstance.apiService?.scanLocation(cid,bid,empno,boxnumber,branchName)
}